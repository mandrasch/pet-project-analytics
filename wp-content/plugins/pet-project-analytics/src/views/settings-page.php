...
?>
<link rel="stylesheet" href="<?php echo plugins_url('assets/dist/css/dashboard.css', PP_ANALYTICS_PLUGIN_FILE); ?>">
<div class="wrap" id="koko-analytics-admin">
    ...
    <div class="ka-admin-container">
        ...
        <form method="POST" action="<?php echo add_query_arg(array('pp_analytics_action' => 'save_settings')); ?>">
            <?php wp_nonce_field('pp_analytics_save_settings'); ?>
            <div class="ka-margin-m">
                ...
                <select id="ka-exclude-user-roles" multiple="" name="pp_analytics_settings[exclude_user_roles][]" style="min-height: <?php echo count($user_roles) * 30; ?>px; min-width: 240px;">
                    <?php
            ...
            <div class="ka-margin-m">
                ...
                <?php
                echo '<textarea id="ka-exclude-ip-addresses" name="pp_analytics_settings[exclude_ip_addresses]" class="widefat" rows="6">';
            ...
            <div class="ka-margin-m">
                <fieldset>
                    ...
                    <label class="ka-setings--cb-label"><input type="radio" name="pp_analytics_settings[use_cookie]" value="1" <?php checked($settings['use_cookie'], 1); ?>><?php esc_html_e('Yes'); ?></label>
                    <label class="ka-setings--cb-label"><input type="radio" name="pp_analytics_settings[use_cookie]" value="0" <?php checked($settings['use_cookie'], 0); ?>> <?php esc_html_e('No'); ?></label>
                </fieldset>
                <p class="description">
            ...
            <div class="ka-margin-m">
                <fieldset>
                    ...
                    <label class="ka-setings--cb-label"><input type="radio" name="pp_analytics_settings[is_dashboard_public]" value="1" <?php checked($settings['is_dashboard_public'], 1); ?>><?php esc_html_e('Yes'); ?></label>
                    <label class="ka-setings--cb-label"><input type="radio" name="pp_analytics_settings[is_dashboard_public]" value="0" <?php checked($settings['is_dashboard_public'], 0); ?>> <?php esc_html_e('No'); ?></label>
                </fieldset>
                <p class="description">
            ...
            <div class="ka-margin-m">
                ...
                <select id="ka-default-date-period" name="pp_analytics_settings[default_view]">
                    <?php
            ...
            <div class="ka-margin-m">
                ...
                <input id="ka-prune-after-input" name="pp_analytics_settings[prune_data_after_months]" type="number" step="1" min="0" max="600" value="<?php echo esc_attr($settings['prune_data_after_months']); ?>"> <?php esc_html_e('months', 'koko-analytics'); ?>
            ...
            <?php do_action('pp_analytics_extra_settings_rows', $settings); ?>
        </form>

        <?php do_action('pp_analytics_show_settings_sections'); ?>
            ...
            <div class="ka-margin-l">
                ...
                <?php } else { ?>
                    ...
                    <form method="POST" action="">
                        <?php wp_nonce_field('pp_analytics_install_optimized_endpoint'); ?>
                        <input type="hidden" name="pp_analytics_action" value="install_optimized_endpoint">
        ...
        <div class="ka-margin-l">
            ...
            <p>
                <?php $seconds_since_last_aggregation = (time() - (int) get_option('pp_analytics_last_aggregation_at', 0)); ?>
            ...
            <div class="ka-margin-m">
                ...
                <form method="POST" action="" onsubmit="return confirm('<?php esc_attr_e('Are you sure you want to reset all of your statistics? This can not be undone.', 'koko-analytics'); ?>')">
                    <?php wp_nonce_field('pp_analytics_reset_statistics'); ?>
                    <input type="hidden" name="pp_analytics_action" value="reset_statistics" />
        ...
        <?php if (! defined('pp_analytics_PRO_VERSION')) { ?>
        <div class="ka-margin-l">
